...
*/
	n1: assert property  (@(posedge S_AXI_ACLK) (faxil_awr_outstanding== (S_AXI_BVALID ? 1:0) + (S_AXI_AWREADY ? 0:1)));
	n2: assert property  (@(posedge S_AXI_ACLK) (faxil_wr_outstanding == (S_AXI_BVALID ? 1:0) + (S_AXI_WREADY ? 0:1)));
	n3: assert property  (@(posedge S_AXI_ACLK) (faxil_rd_outstanding == (S_AXI_RVALID ? 1:0) + (S_AXI_ARREADY ? 0:1)));
	// }}}
	////////////////////////////////////////////////////////////////////////
	//
	...
	*/
	property k1;
		@(posedge S_AXI_ACLK) (!f_past_valid || !$past(S_AXI_ARESETN)) |-> (!S_AXIS_TVALID);
	endproperty 
	auusme_k1: assume property (k1);
	property k2;
		@(posedge S_AXI_ACLK) ($past(S_AXIS_TVALID && !S_AXIS_TREADY)) |-> (S_AXIS_TVALID);
	endproperty 
	property k3;
		@(posedge S_AXI_ACLK) ($past(S_AXIS_TVALID && !S_AXIS_TREADY)) |-> ($stable(S_AXIS_TDATA));
	endproperty 
	property k4;
		@(posedge S_AXI_ACLK) ($past(S_AXIS_TVALID && !S_AXIS_TREADY)) |-> ($stable(S_AXIS_TLAST));
	endproperty 
	auusme_k2: assume property (k2);
	auusme_k3: assume property (k3);
	auusme_k4: assume property (k4);
	...
	*/
	property l1;
		@(posedge S_AXI_ACLK) (!f_past_valid || !$past(S_AXI_ARESETN)) |-> (!M_AXIS_TVALID);
	endproperty
	property l2;
		@(posedge S_AXI_ACLK) ($past(M_AXIS_TVALID && !M_AXIS_TREADY)) |-> (M_AXIS_TVALID);
	endproperty
	property l3;
		@(posedge S_AXI_ACLK) ($past(M_AXIS_TVALID && !M_AXIS_TREADY)) |-> ($stable(M_AXIS_TDATA));
	endproperty
	property l4;
		@(posedge S_AXI_ACLK) ($past(M_AXIS_TVALID && !M_AXIS_TREADY)) |-> ($stable(M_AXIS_TLAST));
	endproperty
	assert_l1: assert property (l1);
	assert_l2: assert property (l2);
	assert_l3: assert property (l3);
	assert_l4: assert property (l4);
	// }}}
	////////////////////////////////////////////////////////////////////////
	//
	// Cover checks
...
*/
	...
	m1: cover property (@(posedge S_AXI_ACLK) (S_AXI_ARESETN && writes_completed == 16));

	m2:	cover property (@(posedge S_AXI_ACLK) (S_AXI_ARESETN && reads_completed == 16));

	m3:	cover property (@(posedge S_AXI_ACLK) (S_AXI_ARESETN && writes_completed == 16 && reads_completed == 16));

	m4:	cover property (@(posedge S_AXI_ACLK) (S_AXI_BVALID && S_AXI_BRESP != 2'b00));

	m5:	cover property (@(posedge S_AXI_ACLK) (S_AXI_RVALID && S_AXI_RRESP != 2'b00));
